           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                  ...
                  <li>
                        <a class="active-menu" href="/md/allloan"><i class="fa fa-square-o fa-3x"></i>All Loans</a>
                    </li> 
...
switch ($t) {
 ...
 ?>   
                                           ...
                                           <th>{{$user['updated_at']}} </th>
                                            <td><a class="btn btn-primary " href="/md/viewloan/{{ $user['id']}}" ><i class="fa fa-edit"></i><b>View More</b></a></td>
