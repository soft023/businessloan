           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a   href="/control/allpendingrequest"><i class="fa fa-qrcode fa-3x"></i>Pending Requests</a>
                    </li>
					
					                   
                   
                  <li>
                        <a  class="active-menu" href="/control/allloan"><i class="fa fa-square-o fa-3x"></i>History</a>
                    </li>	
                </ul>
...
switch ($t) {
 ...
 ?>  
                                           ...
                                           <th>{{$user['updated_at']}} </th>
                                            <td><a class="btn btn-primary " href="/control/viewloan/{{ $user['id']}}" ><i class="fa fa-edit"></i><b>View More</b></a></td>
