           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a  class="active-menu" href="/control/allpendingrequest"><i class="fa fa-qrcode fa-3x"></i>Pending Requests</a>
                    </li>
          
                             
                   
                  <li>
                        <a  href="/control/allloan"><i class="fa fa-square-o fa-3x"></i>History</a>
                    </li> 
                </ul>
...
<h5 class="w3-text-red"> <h4> <b class="w3-red">{{$data['officer']}} Comment :  </b> <br></h4> 
{{$data['rocomment']}}
  </h5>


<h5 class="w3-text-red"> <h4> <b class="w3-red">{{$data['officer']}} Affirmation  :  </b> <br></h4> 
By submitting this form to you, assure that based on my expert knowledge of this customer and businesses hereby propose this loan for approval. I confirm that I have taken all due diligence in the preparation of this Approval Memo and further confirm that I have not received any gratifications in cash or kind for the purpose of securing approval for this request. I hereby undertake that I will monitor this facility diligently and ensure the recovery of same with all best efforts.
  </h5>
...
<div class="row">
  <div class="col-sm-12 col-md-4 col-lg-4 text-right"><br><br><br>
    <a class="btn btn-lg btn-primary " href="/control/allpendingrequest" ><i class=""></i><b>Back</b></a> </div>
  <div class="col-sm-12 col-md-4 col-lg-4  text-center"><br><br><br>
    <a class="btn btn-lg btn-danger " href="/control/decline/{{ $data['id']}}" ><i class=""></i><b>Decline</b></a></div>
  <div class="col-sm-12 col-md-4 col-lg-4 text-left"><br><br><br>
    <a class="btn btn-lg btn-success " href="/control/approve/{{ $data['id']}}" ><i class=""></i><b>Approve</b></a>
  </div>
