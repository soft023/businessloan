           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                        <a  class="active-menu"  href="/ca/approvedloans"><i class="fa fa-qrcode fa-3x"></i>Approved Loans</a>
                    </li>
...
switch ($t) {
 ...
 ?>  
                                           ...
                                           <th>{{$user['updated_at']}} </th>
                                            <td><a class="btn btn-primary " href="/ca/viewapprovedloan/{{ $user['id']}}" ><i class="fa fa-edit"></i><b>Print Certificate</b></a></td>
