...
<div class="row">
  <div class="col-sm-12 col-md-4 col-lg-4 text-right"><br><br><br>
    <a class="btn btn-lg btn-primary " href="/ca/allpendingrequest" ><i class=""></i><b>Back</b></a> </div>
  <div class="col-sm-12 col-md-4 col-lg-4  text-center"><br><br><br>
    <a class="btn btn-lg btn-danger " href="/ca/decline/{{ $data['id']}}" ><i class=""></i><b>Decline</b></a></div>
  <div class="col-sm-12 col-md-4 col-lg-4 text-left"><br><br><br>
    <a class="btn btn-lg btn-success " href="/ca/approve/{{ $data['id']}}" ><i class=""></i><b>Approve</b></a>
  </div>
